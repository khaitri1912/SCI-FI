...
public class MainMenu : MonoBehaviour
{
    ...
    Rect windowRect = new Rect(0, 0, 400, 700);
    ...
    void Start()
    {
        windowRect.x = (Screen.width - windowRect.width) / 8;
        windowRect.y = (Screen.height - windowRect.height) /1.5f;
    }
    ...
    void DoMyWindow(int windowID)
    {
        ...
        GUI.Button(new Rect(0, 80, 400, 160), "Play");
        GUI.Button(new Rect(0, 260, 400, 160), "Setting");
        GUI.Button(new Rect(0, 440, 400, 160), "Store");
